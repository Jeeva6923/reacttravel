...
//     </div>
//     <p id="an"><h3>PREMIUM WINE TASTING EXPERIENCE</h3>
...
function Tasting() {
  ...
  return (
    ...
    <div className="vineyard1">
    <div  id="vineyardnav">
      <img src={wine2} id="imggg" data-aos="zoom-in-up"></img>


      {/* <p id="an">An Exclusive Vineyard Experience
      Join us for an unforgettable journey through the heart of our vineyard and winery, where tradition meets innovation</p> */}
    </div>
    <p id="an" data-aos="zoom-in-up"><h3>Premium Wine Tasting Experience</h3>
    ...
    <div className="vineyard12" data-aos="zoom-in-up">
        <h1 id="ex">PREMIUM WINE</h1>
        <h1 id="vit"> TASTING</h1>
        <h1 id="expt"> EXPERIENCE</h1>
        <div id="tex"><p id="tet">
