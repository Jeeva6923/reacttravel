...
// function WineJourney() {
//   return (
//     <>
//     <div className="vineyard1">
//     <div  id="vineyardnav">
//       <img src={beer} id="imggg"></img>
...
//     </div>
//     <p id="an"><h3>The Ultimate Wine Journey</h3>
...
//         <h1 id="ex">THE ULTIMATE</h1>
//         <h1 id="vii"> WINE JOURNEY</h1>
...
function WineJourney() {
  ...
  return (
    ...
    <div className="vineyard1">
    <div  id="vineyardnav">
      <img src={vinegroup} id="imggg" data-aos="zoom-in-up"></img>


      {/* <p id="an">An Exclusive Vineyard Experience
      Join us for an unforgettable journey through the heart of our vineyard and winery, where tradition meets innovation</p> */}
    </div>
    <p id="an" data-aos="zoom-in-up"><h3>The Ultimate Wine Journey</h3>
      Join us for an unforgettable journey through the heart of our vineyard and <br></br> winery, where tradition meets innovation</p>
    <div className="vineyard12" data-aos="zoom-in-up">
        <h1 id="exj">THE ULTIMATE</h1>
        <h1 id="vij"> WINE JOURNEY</h1>
  ...
  <option value="" id="op1">-Select-</option>
