...
function Reowned() {
  ...
  return (
    ...
    <div  id="vineyardnav">
      <img src={grape} id="imggg" data-aos="zoom-in-up"></img>
    ...
    <p id="an" data-aos="zoom-in-up"><h3>Explore Renowned Wineries</h3>
    ...
    <div className="vineyard12" data-aos="zoom-in-up">
        <h1 id="exr">EXPLORE</h1>
        <h1 id="vir"> REOWNED</h1>
        <h1 id="expr"> WINERIES</h1>
        <div id="tex"><p id="tet">
  ...
  <option value="option2" id="Explore Reowned Wineries">Explore Reowned Wineries</option>
